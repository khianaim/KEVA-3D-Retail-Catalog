    ...
    <>
        {showTutorial && (
          ...
          <div className="flex items-center gap-8">
            <div className="font-light text-[#471515] text-base sm:text-sm hover:font-semibold cursor-pointer">LOG IN</div>
            <div className="font-light text-[#471515] text-base sm:text-sm hover:font-semibold cursor-pointer">SUBSCRIBE</div>
            <div className="font-light text-[#471515] text-base sm:text-sm hover:font-semibold cursor-pointer">HELP</div>
          </div>
